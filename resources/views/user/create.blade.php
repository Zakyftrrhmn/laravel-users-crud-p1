...
<body class="p-10">
    ...
    <p class="uppercase font-bold text-xl text-blue-500">Page Add User</p>

    <form action="{{route('user.store')}}" method="post" enctype="multipart/form-data" class="mt-10 flex flex-col gap-y-5">
        @csrf
